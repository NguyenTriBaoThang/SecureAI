...
{
    public partial class RuleEngineConfiguration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[]
                {
                    "Id", "BlockThreshold", "ReviewThreshold", "AutoBlockEnabled",
                    "AutoAlertEnabled", "BlockMaliciousLabels", "UpdatedAt", "UpdatedByUserId"
                },
                values: new object[]
                {
